...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    // AMD
    define(['raphael', 'eve', 'exports'], function(raphael, eve, exports) {
      // Export global even in AMD case in case this script is loaded with
      // others that may still expect a global Backbone.
      return factory(root, exports, raphael, eve);
    });
  } else {
    // Browser globals
    root.JustGage = factory(root, {}, root.Raphael, root.eve);
  }
}(this, function(root, JustGage, Raphael, eve) {
  ...
  window.setDy = function (elem, fontSize, txtYpos) {
    if (!ie || ie > 9) {
  ...
  /**  Cut hex  */
  window.cutHex = function (str) {
    return (str.charAt(0)=="#") ? str.substring(1,7):str;
  }

  /**  Human friendly number suffix - From: http://stackoverflow.com/questions/2692323/code-golf-friendly-number-abbreviator */
  window.humanFriendlyNumber = function ( n, d ) {
    var p, d2, i, s;
  ...
  /**  Get style  */
  window.getStyle = function (oElm, strCssRule){
    var strValue = "";
  ...
  window.onCreateElementNsReady = function (func) {
